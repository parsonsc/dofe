...
echo "<h1>Executing Test Case</h1>";

$pageTests = new AccountApiTests();

$response = $client->Account->ValidateAccount('david.gurney@thegoodagency.co.uk', 'zhap1091');
		
WriteLine("Account: " . $response->consumerId);
WriteLine("Valid: " . $response->valid);
/*
