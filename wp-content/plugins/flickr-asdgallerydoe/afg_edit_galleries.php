...
if (isset($_POST['afg_edit_gallery_name']) && $_POST['afg_edit_gallery_name']) {
    ...
    if ($_POST['afg_photo_source_type'] == 'photoset') $gallery['photoset_id'] = implode(",",$_POST['afg_photosets_box']);
    else if ($_POST['afg_photo_source_type'] == 'gallery') $gallery['gallery_id'] = implode(",",$_POST['afg_galleries_box']);
    else if ($_POST['afg_photo_source_type'] == 'group') $gallery['group_id'] = implode(",",$_POST['afg_groups_box']);
...
?>
   <div class='wrap'>
   <h2><img src="<?php
    echo (BASE_URL . '/images/logo_big.png'); ?>" align='center'/></a>Edit Galleries | Flickr Gallery</h2>
