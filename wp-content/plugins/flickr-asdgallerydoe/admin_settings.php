...
function afg_admin_menu() {
    add_menu_page('Flickr Gallery', 'Flickr Gallery', 'activate_plugins', 'afg_plugin_page', 'afg_admin_html_page', BASE_URL . "/images/afg_logo.png", 898);
    $afg_main_page = add_submenu_page('afg_plugin_page', 'Default Settings | Flickr Gallery', 'Default Settings', 'activate_plugins', 'afg_plugin_page', 'afg_admin_html_page');
    $afg_add_page = add_submenu_page('afg_plugin_page', 'Add Gallery | Flickr Gallery', 'Add Gallery', 'manage_links', 'afg_add_gallery_page', 'afg_add_gallery');
    $afg_saved_page = add_submenu_page('afg_plugin_page', 'Saved Galleries | Flickr Gallery', 'Saved Galleries', 'manage_links', 'afg_view_edit_galleries_page', 'afg_view_delete_galleries');
    $afg_edit_page = add_submenu_page('afg_plugin_page', 'Edit Galleries | Flickr Gallery', 'Edit Galleries', 'manage_links', 'afg_edit_galleries_page', 'afg_edit_galleries');
    $afg_advanced_page = add_submenu_page('afg_plugin_page', 'Advanced Settings | Flickr Gallery', 'Advanced Settings', 'activate_plugins', 'afg_advanced_page', 'afg_advanced_settings_page');
...
if (trim($flickrid) != ''){
    ...
    $bann_photosets = afg_generate_options($photosets_map, get_option('afg_banned_photoset'), False);
    $rep_photosets = afg_generate_options($photosets_map, get_option('afg_report_photoset'), False);
?>
        <tr valign='top'>
            <th scope='row'>photoset for Banned images</th>
            <td><select name='afg_banned_photoset' id='afg_banned_photoset'><?php echo $bann_photosets;?></select></td>
        </tr>
        <tr valign='top'>
            <th scope='row'>photoset for Reported images</th>
            <td><select name='afg_report_photoset' id='afg_report_photoset'><?php echo $rep_photosets;?></select></td>
        </tr>
<?php        
}
?>
