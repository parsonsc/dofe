...
$afg_slideshow_map = array(
    ...
    'colorbox' => 'Colorbox',
    'highslide' => 'Highslide',
    'googleimage' => 'Thumbnail grid with expand (like google images)',
...
$afg_photo_source_map = array(
    ...
    'users' => 'User Photos',
    'celebs' => 'Celebs Photos',
    'userscelebs' => 'Users & Celebs Photos',
);
...
function afg_get_cur_url() {
    ...
    if (strpos($_SERVER["HTTP_HOST"], ':'.$_SERVER["SERVER_PORT"] ) !== false) $port = '';       
...
function afg_error() {
    global $pf;
    return "<h3>Flickr Gallery Error - $pf->error_msg</h3>";
}
...
function afg_generate_flickr_settings_table($photosets, $galleries, $groups, $defaulta='', $defaultb='', $defaultc='' ) {
    global $afg_photo_source_map;
    $photosets = afg_generate_options($photosets, $defaulta, False);
    $galleries = afg_generate_options($galleries, $defaultb, False);
    $groups = afg_generate_options($groups, $defaultc, False);
    return "
    <div id=\"poststuff\">
<div class=\"postbox\" style='box-shadow:0 0 2px'>
    ...
    <table class='form-table'>
        ...
        <td><select style='display:none' name='afg_photosets_box[]' id='afg_photosets_box'  multiple='multiple' size='5'>$photosets
        </select>
        <select style='display:none' name='afg_galleries_box[]' id='afg_galleries_box' multiple='multiple' size='5'>$galleries
        </select>
        <select style='display:none' name='afg_groups_box[]' id='afg_groups_box' multiple='multiple' size='5'>$groups
        </select>
