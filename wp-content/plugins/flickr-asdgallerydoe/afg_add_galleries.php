...
function afg_add_gallery() {
   ...
   <div class='wrap'>
   <h2><img src="<?php
    echo (BASE_URL . '/images/logo_big.png'); ?>" align='center'/>Add Gallery | Flickr Gallery</h2>
...
<?php
        if ($_POST && $_POST['afg_add_gallery_name']) {
            ...
            if ($_POST['afg_photo_source_type'] == 'photoset')
                $gallery['photoset_id'] = implode(",",$_POST['afg_photosets_box']);
            else if ($_POST['afg_photo_source_type'] == 'gallery')
                $gallery['gallery_id'] = implode(",",$_POST['afg_galleries_box']);
            else if ($_POST['afg_photo_source_type'] == 'group')
                $gallery['group_id'] = implode(",",$_POST['afg_groups_box']);
...
<?php
    echo afg_generate_flickr_settings_table($photosets_map, $galleries_map, $groups_map, $default);
