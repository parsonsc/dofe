...
function jg_front_end_pagedetail($atts){
    ...
    if (trim($template) == '') $template = 'page-detail.html'; 
    
    $events = array();
    
    $pageDetails = $client->Pages->Retrieve($_GET['pid']);  
    $donations = $client->Pages->RetrieveDonationsForPage($_GET['pid'],$pagesize,$_GET['page']);
