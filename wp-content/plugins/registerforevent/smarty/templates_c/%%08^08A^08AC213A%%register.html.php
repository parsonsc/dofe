<?php /* Smarty version 2.6.28, created on 2015-06-17 15:23:21
...
" class="input-text password <?php if ($this->_tpl_vars['Errors']['cpassword']['message'] != ''): ?>error<?php endif; ?>"  />
    ...
    <input type="hidden" name="corporate" value="<?php  global $organizer_shortname; echo $organizer_shortname  ?>" />
